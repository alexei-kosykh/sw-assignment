...
import { COTitleContainer } from './CartOverlayTitle';
import { COTotalContainer } from './CartOverlayTotal';
import { COButtonContainer } from './CartOverlayButton';
import { COCounterContainer } from './CartOverlayCounter';
...
export class CartOverlay extends Component {
  render() {
    ...
    return (
      <>
        {this.props.hasItems && <COCounterContainer />}
